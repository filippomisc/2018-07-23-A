...
public class NewUfoSightingsController {
	...
	void doCreaGrafo(ActionEvent event) {
		...
		txtResult.setText(model.neighbohrString());
	...
	void doSelezionaAnno(ActionEvent event) {
		...
		if (model.isValid(anno)==false) {
			this.txtResult.appendText("l'anno selezionato non è presente nel database. selezionare un anno dal 1910 al 2014");
			return;
		}
		

		 this.cmbBoxForma.getItems().addAll(model.getForme(anno));
		 this.txtResult.setText("forme create!");
